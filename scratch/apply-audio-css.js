...
const respJsPath = path.join(__dirname, '..', 'scratch', 'apply-responsive-css.js');
let respJs = fs.readFileSync(respJsPath, 'utf8');
...
if (!respJs.includes('MASTER AI AUDIO READER & NARRATION ENGINE')) {
  respJs = respJs.replace('`\n\nfs.writeFileSync', audioCssBlock + '`\n\nfs.writeFileSync');
  fs.writeFileSync(respJsPath, respJs, 'utf8');
  console.log('✔ Audio CSS appended to scratch/apply-responsive-css.js');
} else {
  console.log('✔ Audio CSS already present in scratch/apply-responsive-css.js');
}

// Run apply-responsive-css.js to rebuild styles.css
require('./apply-responsive-css.js');
console.log('✔ styles.css successfully updated with Master Audio Reader styles!');
